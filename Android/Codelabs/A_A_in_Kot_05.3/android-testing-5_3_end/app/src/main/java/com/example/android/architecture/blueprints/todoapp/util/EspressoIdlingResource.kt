...
/**
 * wrapEspressoIdlingResourceначинается с увеличения счетчика, запускает любой код, который он обернут, а затем уменьшает счетчик. Вот пример того, как вы бы использовали wrapEspressoIdlingResource:
